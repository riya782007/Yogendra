                    ...
                    <td className="p-3 text-right">
                      <div className="flex flex-col items-end gap-1.5">
                        ...
                        <Link
                          ...
                          className="px-3 py-1 rounded-full border border-ink/20 text-ink text-[11px] hover:bg-ink/5 whitespace-nowrap"
                          title="Edit quantities, lines, or add a staff note on this COD order"
                        >
                          ✎ Edit bill
                        </Link>
