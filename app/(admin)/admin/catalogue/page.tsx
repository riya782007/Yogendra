    ...
    <main className="p-4 sm:p-8 bg-cream/40 min-h-screen">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
        ...
        <div className="flex gap-2">
          <Link href={`${SITE}/catalog?manage=1`} target="_blank" className="px-4 py-2.5 text-sm font-medium rounded-full bg-gold text-ink hover:opacity-90 transition-opacity">📤 Share Catalogue ↗</Link>
          {canAi && <>
