...
import { generateContentAction, generateAllContentAction, fixNathListingsAction } from "@/app/actions/aiContent";
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          {canAi && <>
            ...
            <form action={fixNath}><button className="px-4 py-2.5 text-sm font-medium rounded-full border border-gold text-gold-dark hover:bg-gold/15 transition-colors" title="Rewrite existing nath / nose-pin listings that still say Pendant Chain or Other Accessories">👃 Fix nath specs</button></form>
