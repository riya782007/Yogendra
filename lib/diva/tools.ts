...
export const DIVA_TOOLS: DivaTool[] = [
  ...
  { name: "set_price", kind: "mutate", permission: "catalog.price_edit", confirm: true, desc: "Set a product's base/wholesale price in ₹ (retail & MRP re-derive).", params: [{ name: "sku", type: "string", required: true, desc: "product SKU" }, { name: "price", type: "number", required: true, desc: "wholesale/base price in ₹" }] },
