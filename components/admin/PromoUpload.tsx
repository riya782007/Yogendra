  ...
  return (
    <div className="bg-white rounded-2xl shadow-card border border-sand p-5 mb-6">
      ...
      <div className="mt-5 pt-4 border-t border-sand">
        ...
        {type === "strip" ? (
          <div className="bg-ink text-gold-light/90 text-xs py-2 px-4 rounded-lg overflow-hidden whitespace-nowrap">✦ {headline || "Your announcement message"} &nbsp;&nbsp; ✦ Flat ₹100 shipping &nbsp;&nbsp; ✦ Cash on Delivery</div>
        ) : type === "popup" ? (
