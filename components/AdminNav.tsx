...
const GROUPS: { title: string; links: L[] }[] = [
  ...
  { title: "Catalog", links: [
    ...
    { href: "/admin/stock-reconciliation", label: "Stock Count", icon: "✓", perm: "inventory.view" },
  ...
  { title: "Sales & Billing", links: [
    ...
    { href: "/admin/wholesale-payments", label: "Wholesale Payments", icon: "✅", perm: "billing.sell" },
